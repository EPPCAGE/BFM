...
export const POKEMON_CARDS: PokemonCardDef[] = [
  ...
  },
  {
    ...
    attacks: [
      { name: 'Confiar', cost: 0, damage: 0, effect: 'Compre 3 cartas.' },
  ...
  },
  {
    ...
    attacks: [
      { name: 'Fedor', cost: 0, damage: 0, effect: 'O Pokémon atacante desta rodada perde 20 de dano.' },
  ...
  },
  {
    ...
    attacks: [
      { name: 'Teletransporte', cost: 0, damage: 0, effect: 'Troque este Pokémon com um da sua mão (se houver). O novo Pokémon entra vulnerável.' },
      { name: 'Confusão', cost: 1, damage: 20 },
    ],
  },
  {
